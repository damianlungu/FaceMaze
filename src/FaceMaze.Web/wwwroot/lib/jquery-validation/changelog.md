...
===================
  ...
  * Improve tooltip handling on introrollered demo
  * Add type="text" to input fields without type attribute to please qSA
  * Update introrollered demo to use tooltip to show errors as overlay.
  * Update introrollered demo to use latest jQuery UI (along with newer jQuery version). Move code around to speed up page load.
...
* Added jQuery UI introrolled demo
* Removed cmxform.js
