...
[![devDependency Status](https://david-dm.org/jzaefferer/jquery-validation/dev-status.svg?intro=shields.io)](https://david-dm.org/jzaefferer/jquery-validation#info=devDependencies)
